...
// if the form's update button is clicked,need to process the form
	if (isset($_POST['update'])) {
		...
		$sql = "UPDATE `customer` SET `customerID`='$customerID',`customerName`='$customerName',`PASSWORD`='$PASSWORD',`teleNo`='$teleNo,`email`='$email' WHERE `customerID`='$customerID'";
...
// if the 'id' variable is set in the URL, can know that need to edit a record
	...
	<div class="signup-box">
            ...
            <div class="input-group">
              <p>
                ...
                <input class="input-text" type="password" id="txtPassword" name="password" placeholder="Enter password..." value="<?php echo $PASSWORD; ?>">
              </p>
            </div>   
            <div class="input-group">
              <p>
                <label class="input-label">Confirm Password</label>
                <input class="input-text" type="password" id="txtConfirm_Password" name="confirmpassword" placeholder="Confirm password..." value="<?php echo $PASSWORD; ?>">
              </p>
            </div>
            <div class="input-group">
              <p>
